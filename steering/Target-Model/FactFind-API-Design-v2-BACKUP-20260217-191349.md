...
**Purpose:** Provide aggregated financial position snapshot including net worth, asset allocation, and income vs. expenditure comparison.
...
#### 4.4.1 Get Current Position Summary

**Endpoint:** `GET /api/v1/factfinds/{factfindId}/current-position`

**Description:** Get comprehensive financial position summary for a fact find.
...
```json
{
  ...
  "financialHealthIndicators": {
    "debtToIncomeRatio": 31.8,
    "debtToAssetRatio": 29.4,
    "loanToValueRatio": 48.9,
  ...
  "recommendations": [
    {
      ...
      "recommendation": "Emergency fund is adequate at 5.5 months expenses",
      "action": "Maintain current emergency fund level"
    },
    {
      "priority": "Medium",
      "category": "Debt Management",
      "recommendation": "Debt-to-income ratio of 31.8% is manageable",
      "action": "Consider accelerating mortgage payments with surplus income"
    },
    {
      "priority": "Low",
      "category": "Diversification",
      "recommendation": "Portfolio is well diversified",
      "action": "Continue regular portfolio reviews"
    }
  ],
  "_links": {
    "self": { "href": "/api/v1/factfinds/{factfindId}/current-position" },
    "assets": { "href": "/api/v1/factfinds/{factfindId}/assets" },
    "liabilities": { "href": "/api/v1/factfinds/{factfindId}/liabilities" },
    "income": { "href": "/api/v1/factfinds/{factfindId}/income" },
    "expenditure": { "href": "/api/v1/factfinds/{factfindId}/expenditure" },
    "arrangements": { "href": "/api/v1/factfinds/{factfindId}/arrangements" }
  }
}
```

**Health Score Calculation:**
- **Emergency Fund:** 20 points (0-6 months coverage)
- **Debt-to-Income Ratio:** 25 points (lower is better, <36% is good)
- **Savings Rate:** 20 points (higher is better, >15% is good)
- **Diversification:** 20 points (assessed by asset allocation spread)
- **Net Worth Growth:** 15 points (year-over-year comparison)
...
**Purpose:** Manage identity verification, KYC compliance, and AML checks.
...
- Verification provider integration (e.g., Onfido, Jumio)
- Regulatory compliance tracking (MLR 2017)

**Note:** For complete identity verification endpoints including document upload, KYC workflow, AML screening, and verification status tracking, see the full v2.0 document section 5.5.

### 5.6 Data Protection & Consent API

**Purpose:** Manage GDPR consent, data processing agreements, and audit trail.

**Scope:**
- GDPR consent management with purpose specification
- Data processing consent tracking
- Data retention policies and expiry
...
**Note:** For complete data protection endpoints including consent management, GDPR compliance workflows, data subject rights, and audit trail tracking, see the full v2.0 document section 5.6.

### 5.7 Marketing Preferences API

**Purpose:** Manage marketing consent and communication channel preferences.
...
**Note:** For complete marketing preferences endpoints including preference management, channel consent, opt-in/opt-out workflows, and suppression list handling, see the full v2.0 document section 5.7.
...
**Purpose:** Manage property portfolio with valuation tracking and mortgage linking.

**Scope:**
- Property entity management (residential, buy-to-let, commercial)
- Property valuation history
- Loan-to-Value (LTV) calculations
- Rental income tracking
- Property expenses and yield calculations
- Mortgage linking and equity tracking
- Capital gains tracking

**Note:** For complete property management endpoints including property CRUD operations, valuation tracking, LTV calculations, and rental yield analysis, see the full v2.0 document section 9.4.

### 9.5 Equities Portfolio API

**Purpose:** Track direct stock holdings and portfolio performance.
...
- Capital gains and loss tracking
- Corporate actions (splits, dividends, rights issues)
- Market data integration

**Note:** For complete equities portfolio endpoints including stock holdings management, performance tracking, dividend capture, and capital gains reporting, see the full v2.0 document section 9.5.

### 9.6 Credit History API

**Purpose:** Track credit score, payment history, and credit reports for comprehensive credit assessment.
...
- Default and CCJ tracking
- Credit improvement recommendations

**Note:** For complete credit history endpoints including credit score monitoring, payment history tracking, credit report integration, and credit health indicators, see the full v2.0 document section 9.6.
...
- Version control and regulatory approval tracking
- Question bank administration with scoring algorithms
- Risk rating categories and asset allocation recommendations
- Template distribution and activation
- Regulatory compliance tracking (FCA, MiFID II)

**Note:** For complete risk questionnaire endpoints including template management, question administration, and scoring rules, see the full v2.0 document section 10.4.
...
- Risk Replay mechanism for regulatory compliance
- Risk rating evolution tracking
- Questionnaire response history with timestamps
- Significant change documentation and justification

**Note:** For complete risk assessment history endpoints including historical tracking, Risk Replay comparison, and audit trail features, see the full v2.0 document section 10.5.
...
**Scope:**
- Risk-specific supplementary questions (dependants, time horizon, emergency funds)
- General supplementary questions (Will, LPA, estate planning)
- Compliance supplementary questions (previous advice, understanding disclosures)
- Custom question sets per firm
- Question response tracking with audit trail
- Completion status monitoring

**Note:** For complete supplementary questions endpoints including question management, response capture, and completion tracking, see the full v2.0 document section 10.6.
...
**Scope:**
- Client declarations (fact find accuracy, risk warnings, advice understanding)
- Adviser declarations (suitability assessment, compliance confirmation)
- Data protection consent (GDPR, data processing, retention)
- Marketing consent with channel preferences
- Regulatory disclosures and acknowledgments
- Electronic and wet signature capture
- Declaration versioning and audit trail
- Signature verification with IP address and timestamp tracking

**Note:** For complete declaration capture endpoints including signature workflows, consent management, and regulatory compliance tracking, see the full v2.0 document section 10.7.
