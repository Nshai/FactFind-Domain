...
- Credit-History data must be accurate and up-to-date
...
**Happy Path:**
1. Create Credit-History with valid data
2. Retrieve Credit-History by ID
3. Update Credit-History fields
