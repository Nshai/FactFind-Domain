...
- Estate-Planning data must be accurate and up-to-date
...
**Happy Path:**
1. Create Estate-Planning with valid data
2. Retrieve Estate-Planning by ID
3. Update Estate-Planning fields
4. Delete Estate-Planning
