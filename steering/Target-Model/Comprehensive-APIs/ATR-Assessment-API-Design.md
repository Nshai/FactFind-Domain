...
- ATR-Assessment data must be accurate and up-to-date
...
**Happy Path:**
1. Create ATR-Assessment with valid data
2. Retrieve ATR-Assessment by ID
3. Update ATR-Assessment fields
4. Delete ATR-Assessment
