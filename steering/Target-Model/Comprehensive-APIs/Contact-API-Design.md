...
**Required Scopes:**
- `contact:read` - Read access (GET operations)
- `contact:write` - Create and update access (POST, PUT, PATCH)
- `contact:delete` - Delete access (DELETE operations)
...
- Contact data must be accurate and up-to-date
...
**Happy Path:**
1. Create Contact with valid data
