...
- Financial-Profile data must be accurate and up-to-date
...
**Happy Path:**
1. Create Financial-Profile with valid data
2. Retrieve Financial-Profile by ID
3. Update Financial-Profile fields
4. Delete Financial-Profile
