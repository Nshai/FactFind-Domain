...
SET ANSI_NULLS ON
GO
CREATE Procedure [dbo].[nio_SpCustomSearchClientFullSecureByFee]
	(
		@TenantId bigint,   
...
SELECT  
   ...
   WHERE TF.IndigoClientId=@TenantId  
   AND TFRO.IndigoClientId=@TenantId  
