...
*/
CREATE PROCEDURE [dbo].[SpNioCustomPartyByCustomerStatus_v2]	
	 @CRMContactIds CRMContactIdListType READONLY , @TenantId INT, @CRMContactStatusId INT
AS
...
INNER JOIN @CRMContactIds cid  ON ct.CRMContactId = cid.CRMContactId
