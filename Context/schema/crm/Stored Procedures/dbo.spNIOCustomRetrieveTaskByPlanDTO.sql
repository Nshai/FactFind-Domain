...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spNIOCustomRetrieveTaskByPlanDTO]    
 @TenantId int,
 @PolicyId bigint    
AS    
...
Select OrganiserActivityId,TaskId,SequentialRef, PriorityName, DueDate,[Subject],AssignedUserId, AssignedUser,AssignedToUserId,    
 AssignedToUser,TaskStatus,CaseRef,ClientName,ClientPartyId,JointClientName,JointClientPartyId,CompleteFG,RoleId,RoleName,PolicyId,FeeId,    
 RetainerId,OpportunityId,AdviceCaseId, ActivityType,IndigoClientId,EventListName,StartDate,TaskType,PlanTypeName
 ,IsDocumentExist,PlanTypeId,IsBillable    
