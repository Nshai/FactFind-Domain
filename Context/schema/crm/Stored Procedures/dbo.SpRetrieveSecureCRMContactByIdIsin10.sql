...
SET ANSI_NULLS OFF
GO
CREATE PROCEDURE [dbo].[SpRetrieveSecureCRMContactByIdIsin10]
@CRMContactId1 bigint,
@CRMContactId2 bigint,
@CRMContactId3 bigint,
@CRMContactId4 bigint,
@CRMContactId5 bigint,
@CRMContactId6 bigint,
@CRMContactId7 bigint,
@CRMContactId8 bigint,
@CRMContactId9 bigint,
@CRMContactId10 bigint,
@_UserId bigint
AS
...
BEGIN
  ...
  WHERE (T1.CRMContactId IN (@CRMContactId1,@CRMContactId2,@CRMContactId3,@CRMContactId4,@CRMContactId5,@CRMContactId6,@CRMContactId7,@CRMContactId8,@CRMContactId9,@CRMContactId10) )
