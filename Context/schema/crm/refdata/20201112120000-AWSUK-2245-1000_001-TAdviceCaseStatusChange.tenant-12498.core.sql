...
BEGIN TRY
    ...
    BEGIN TRANSACTION
        ...
        SELECT 14330,12498,10947,10948,1 UNION ALL 
        SELECT 14331,12498,10948,10949,1 UNION ALL 
        SELECT 14332,12498,10949,10948,1 UNION ALL 
        SELECT 14333,12498,10948,10947,1 
