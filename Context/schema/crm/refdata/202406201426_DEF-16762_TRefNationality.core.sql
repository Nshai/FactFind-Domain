...
DECLARE @ScriptGUID UNIQUEIDENTIFIER
	...
	, @Name VARCHAR(50) = 'Turkmen'
	, @RefCountryId int = 26
	, @RefNationalityId int
	, @ISOAlpha3Code VARCHAR(50) = 'TKM'

/*
Summary
DEF-16762 - Add nationality Turkmen
...
SELECT 
	@ScriptGUID = '9F1012F1-7CA1-489B-8787-86B61DC9E0A6', 
	@Comments = 'DEF-16762 - Add nationality Turkmen' 
