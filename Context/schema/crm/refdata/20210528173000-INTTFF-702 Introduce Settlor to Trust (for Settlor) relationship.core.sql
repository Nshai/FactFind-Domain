...
SELECT
    @ScriptGUID = '6A6DC011-C166-4C5B-875B-677D667CE7D1',
    @Comments = 'INTTFF-702 Introduce Settlor to Trust (for Settlor) relationship'

IF EXISTS (SELECT 1 FROM TExecutedDataScript WHERE ScriptGUID = @ScriptGUID)
    RETURN;

-----------------------------------------------------------------------------------------------
-- Summary: Introduce Settlor to Trust (for Settlor) relationship
...
BEGIN TRY
    ...
    IF @starttrancount = 0
        BEGIN TRANSACTION
            ...
            SET @SettlorForTrustRelationshipTypeId = 859
