...
BEGIN TRY
    ...
    BEGIN TRANSACTION
        ...
        SELECT 1511, 'Initial',0,1,466,1,NULL UNION ALL 
        SELECT 1512, 'Deferred',0,2,466,1,NULL UNION ALL 
        SELECT 1513, 'Qualified',1,3,466,1,NULL UNION ALL 
        SELECT 1514, 'Closed',0,4,466,1,NULL 
