...
BEGIN TRY
    ...
    BEGIN TRANSACTION
        ...
        SELECT 31451, 'Lump sum investment',12498,1,0,0,0,2, NULL UNION ALL 
        SELECT 31453, 'Protection',12498,1,0,0,0,2, NULL UNION ALL 
        SELECT 31456, 'Mortgage',12498,1,1,0,0,2, NULL UNION ALL 
        SELECT 31457, 'Mortgage(Non-Regulated)',12498,1,1,0,0,2, NULL UNION ALL 
        SELECT 31458, 'Equity Release',12498,1,1,0,0,2, NULL UNION ALL 
        ...
        VALUES (
         ...
         'Initial load (7 total rows, file 1 of 1) for table TOpportunityType',
         12498, 
         getdate() )
