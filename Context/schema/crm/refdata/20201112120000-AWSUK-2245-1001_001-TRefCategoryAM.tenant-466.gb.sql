...
BEGIN TRY
    ...
    BEGIN TRANSACTION
        ...
        SELECT 1473, 'Business',0,466,NULL,1 UNION ALL 
        SELECT 1474, 'Personal',0,466,NULL,1 UNION ALL 
        SELECT 1475, 'Party',0,466,NULL,1 UNION ALL 
        SELECT 1476, 'Team Building',0,466,NULL,1 
