...
--    Join: 
--   Where: WHERE TenantId=466 and themeid = '00000000-0000-0000-0000-000000000002'
-----------------------------------------------------------------------------
...
BEGIN TRY
    ...
    BEGIN TRANSACTION
        ...
        SELECT 'ADFED94B-EBD0-E211-8C38-68B599732474','00000000-0000-0000-0000-000000000002',466,1 
