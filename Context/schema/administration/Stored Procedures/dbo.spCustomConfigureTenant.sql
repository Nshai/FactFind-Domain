...
--drop PROCEDURE [dbo].[spCustomConfigureTenant]       
CREATE PROCEDURE [dbo].[spCustomConfigureTenant]       
...
Declare @ParentGroupingID bigint, @CountyId bigint, @SourceIndigoClientId bigint      
      
Select @SourceIndigoClientId=IndigoClientId from administration..TSourceIndigoClient      
...
-- Create the Grouping    
EXEC spCustomCreateGroupingForNewTenant @NewTenantId, @SourceIndigoClientId
    
-- create the Group    
EXEC spCustomCreateGroupForNewTenant @NewTenantId, @SourceIndigoClientId

   
-- ok lets now do the roles    
EXEC spCustomCreateRolesForNewTenant @NewTenantId, @SourceIndigoClientId
