...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[SpCustomSearchUserByUEmail]  
...
IF (@_TopN > 0) SET ROWCOUNT @_TopN  
  ...
  SELECT  
    ...
    NULL AS [CRMContact!3!_ParentId],   
    NULL AS [CRMContact!3!_ParentTable],   
    NULL AS [CRMContact!3!_ParentDb],   
    NULL AS [CRMContact!3!_OwnerId],   
