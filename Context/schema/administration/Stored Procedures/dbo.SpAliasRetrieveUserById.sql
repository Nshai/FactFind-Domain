...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[SpAliasRetrieveUserById]
@UserId bigint
AS
...
BEGIN
  SELECT
    ...
    NULL AS [IndigoClient!5!MaxFinancialPlanningUsers], 
    ...
    NULL AS [IndigoClient!5!IsAtrProvider], 
  ...
  SELECT
    ...
    ISNULL(T5.MaxFinancialPlanningUsers, ''), 
