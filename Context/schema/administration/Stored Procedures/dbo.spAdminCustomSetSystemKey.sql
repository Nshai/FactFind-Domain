USE [administration]
GO
/****** Object:  StoredProcedure [dbo].[spAdminCustomSetSystemKey]    Script Date: 08/06/2022 08:51:40 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[spAdminCustomSetSystemKey]
	@TenantId int,
	@StampUserId int,
	@SystemId int,
	@RightMask int,
...
BEGIN
	...
	' OUTPUT ' +
		...
		' ''D'',                   ' +
		' GETUTCDATE(),            ' +
		' CAST(@StampUserId as varchar (255))' +
	' INTO ' +
