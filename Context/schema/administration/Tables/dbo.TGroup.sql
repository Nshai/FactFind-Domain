...
GO
ALTER TABLE [dbo].[TGroup] WITH CHECK ADD CONSTRAINT [FK_TGroup_GroupingId_GroupingId] FOREIGN KEY ([GroupingId]) REFERENCES [dbo].[TGrouping] ([GroupingId])
GO
ALTER TABLE [dbo].[TGroup] WITH CHECK ADD CONSTRAINT [FK_TGroup_ParentId_GroupId] FOREIGN KEY ([ParentId]) REFERENCES [dbo].[TGroup] ([GroupId])
GO
