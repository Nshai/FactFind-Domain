...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE dbo.SpNioCustomPolicyBusinessForExternalSystemByApplicationReference
	@ApplicationReference VARCHAR(255), 
...
BEGIN	
    ...
    WHERE  PExt.ApplicationReference = @ApplicationReference AND p.indigoclientid = @IndigoClientId
END
GO