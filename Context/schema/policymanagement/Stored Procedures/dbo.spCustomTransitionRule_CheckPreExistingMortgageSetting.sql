...
CREATE PROCEDURE [dbo].[spCustomTransitionRule_CheckPreExistingMortgageSetting]
...
AS
	...
	set @Valid = 
		(
			Select count(1) From FactFind..TMortgageMiscellaneous
	...
	BEGIN
		...
		select @ErrorMessage = 'PREEXISTINGMORTGAGESSETTING_::FactFindId=' + CONVERT(varchar(20),@FactFindId) + '::'+ 
