...
CREATE PROCEDURE [dbo].[SpCustomTransitionRule_CheckTargetMarket]
...
AS    
	...
	SELECT @IsTargetMarket = IsTargetMarket From TPolicyBusinessExt
	Where PolicyBusinessId = @PolicyBusinessId
    
	IF (@IsTargetMarket IS NOT NULL)
	BEGIN
		SET @Valid1 = 1
