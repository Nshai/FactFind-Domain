...
CREATE PROCEDURE [dbo].[SpRetrieveAUSuperSummary] @PolicyBusinessId BIGINT,@TenantId BIGINT,@ProductTypeId BIGINT
AS
     BEGIN
         ...
         SELECT pp.protectionid,
			 ...
			 PInfo.UntaxedPensionAmount,
			 b1.BenefitId,
			 PInfo.TaxedPensionAmount
