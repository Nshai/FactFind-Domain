...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[SpCustomCreatePlan]       
 @CRMContactId bigint,      
...
begin      
 ...
 Declare @PolicyBusinessId bigint, @PolicyDetailId bigint, @TnCCoachId bigint      
...
END
 ...
 VALUES(  @PolicyBusinessId,   @BandingTemplateId,   null,   null,  1)        
...
WHERE PolicyBusinessId=@PolicyBusinessId  
 ...
 pb.PractitionerId as [PolicyBusiness!1!PractitionerId],      
