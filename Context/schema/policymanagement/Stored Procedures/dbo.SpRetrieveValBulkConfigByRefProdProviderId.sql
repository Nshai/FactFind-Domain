...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[SpRetrieveValBulkConfigByRefProdProviderId]  
...
BEGIN    
	...
	SELECT  
		...
		T1.ProviderFileDateOffset AS [ValBulkConfig!1!ProviderFileDateOffset],   
	...
	ORDER BY [ValBulkConfig!1!ValBulkConfigId]  FOR XML EXPLICIT    
END  
RETURN (0)    
GO
