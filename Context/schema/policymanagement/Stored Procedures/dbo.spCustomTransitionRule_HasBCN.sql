...
CREATE PROCEDURE [dbo].[spCustomTransitionRule_HasBCN]
...
DECLARE @Owners TABLE (OwnerNumber int IDENTITY(1,1) PRIMARY KEY, 
	PolicyOwnerId bigint, CRMContactId bigint, BCN Varchar(100),
	Name Varchar(255)
)

	Insert into @Owners
	Select
		O.PolicyOwnerId, CRM.CRMContactId, CRM.ExternalReference,
