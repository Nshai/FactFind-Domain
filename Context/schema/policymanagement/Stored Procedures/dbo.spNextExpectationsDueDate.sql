...
GO
 /***************************************************************************************************
 Object:  StoredProcedure [dbo].[spNextExpectationsDueDate]    
 Script Date: 15/04/2013 12:08:34 
 Description: This stored procedure calucates the next due date based on the frequency, start date and last due date
 ****************************************************************************************************/

CREATE procedure [dbo].[spNextExpectationsDueDate]  
(  
@feeId bigint = 0,  
@startDate date,  
@lastDueDate date,  
