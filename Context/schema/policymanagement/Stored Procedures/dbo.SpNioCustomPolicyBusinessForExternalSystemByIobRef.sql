...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE dbo.SpNioCustomPolicyBusinessForExternalSystemByIobRef 	
	@IobReference VARCHAR(100), 
...
BEGIN	
	...
	SELECT	TOP 1
			p.policybusinessid				AS PolicyBusinessId,
    ...
    WHERE  p.SequentialRef = @IobReference AND p.indigoclientid = @IndigoClientId
END
GO