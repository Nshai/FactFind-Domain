...
GO
/*
	Custom Sp to delete valuation schedule policy by ValScheduleId
	LIO Procedure: SpDeleteValSchedulePolicyByValScheduleId
*/  

  
Create PROCEDURE [dbo].[nio_ContractEnquiry_DeleteValuationSchedulePolicyByValScheduleId]
