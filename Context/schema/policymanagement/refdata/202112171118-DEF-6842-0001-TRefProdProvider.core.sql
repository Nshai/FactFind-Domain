...
SELECT @ScriptGUID = 'A2C91220-8E16-4CBC-82EC-78C5398FE04A'
	,@Comments = 'DEF-6842 Create Providers'
...
BEGIN TRY
	...
	VALUES 
		 ('Sapphire Capital Partners LLP','GB',0,0,0)
