...
SELECT @ScriptGUID = 'AE915DDC-6676-4323-84B4-21E8C17E0322'
	,@Comments = 'DEF-7776 Create Providers'
...
-- Expected records added: 4 row(s)
-----------------------------------------------------------------------------------------------
SET NOCOUNT ON
SET XACT_ABORT ON
...
BEGIN TRY
	...
	VALUES 
		 ('Standard Life Home Finance','GB',0,0,0),
		 ('eToro (UK) Ltd','GB',0,0,0),
		 ('Butterfield Mortgages Limited','GB',0,0,0),
		 ('Development Company for Israel (International) Ltd','GB',0,0,0)
