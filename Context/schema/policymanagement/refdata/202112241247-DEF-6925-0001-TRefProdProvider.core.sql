...
SELECT @ScriptGUID = '914AD15A-965E-44DC-BB23-D4465F55E0C1'
	,@Comments = 'DEF-6925 Create Providers'
...
BEGIN TRY
	...
	VALUES 
		 ('Starr International (Europe) Limited','GB',0,0,0),
		 ('Lifeworks','GB',0,0,0),
		 ('Options UK Personal Pensions LLP','GB',0,0,0),
		 ('WM Capital Management','GB',0,0,0)
