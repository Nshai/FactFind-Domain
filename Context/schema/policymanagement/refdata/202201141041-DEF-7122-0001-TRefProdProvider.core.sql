...
SELECT @ScriptGUID = '7559BF94-FCCB-4564-A473-D88D56656910'
	,@Comments = 'DEF-7122 Create Providers'
...
BEGIN TRY
	...
	VALUES 
		 ('Suffolk Building Society','GB',0,0,0),
		 ('Generation Home','GB',0,0,0)
