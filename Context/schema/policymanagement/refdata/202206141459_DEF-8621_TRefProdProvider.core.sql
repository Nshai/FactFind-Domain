...
SELECT @ScriptGUID = '38EE2398-B7A2-446B-936D-6C5ACDF43367'
	,@Comments = 'DEF-8621 Create Providers & archive provider'
...
-----------------------------------------------------------------------------------------------
-- Summary: Add new provider(s) and archives one provider
-- Expected records added: 2 row(s)
-- Expected records update: 1 row(s)
-----------------------------------------------------------------------------------------------
SET NOCOUNT ON
SET XACT_ABORT ON
...
DECLARE @starttrancount INT
	...
	,@RefProdProviderIdToArchive int = 2806
...
BEGIN TRY
	...
	VALUES 
		 ('Octium Life DAC','GB',0,0,0),
		 ('LGT Wealth Management UK LLP','GB',0,0,0)
	...
	WHERE RefProdProviderId = @RefProdProviderIdToArchive
