...
SELECT @ScriptGUID = '7A1F7D2D-2C54-4429-ADED-B881E806B70D'
	,@Comments = 'DEF-6417 Create Provider Bellecapital UK Ltd'
...
-----------------------------------------------------------------------------------------------
-- Summary: Add new Bellecapital UK Ltd provider 
-- Expected records added: 2 rows
-----------------------------------------------------------------------------------------------
SET NOCOUNT ON
SET XACT_ABORT ON
