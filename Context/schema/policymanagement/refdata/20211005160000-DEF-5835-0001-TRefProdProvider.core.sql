...
SELECT @ScriptGUID = '0494544E-A83F-458B-8B57-B0976E117219'
	,@Comments = 'DEF-5835 Create Provider DF Capital'
...
-----------------------------------------------------------------------------------------------
-- Summary: Add new DF Capital provider 
-- Expected records added: 4 rows
-----------------------------------------------------------------------------------------------
SET NOCOUNT ON
SET XACT_ABORT ON
