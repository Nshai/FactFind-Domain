...
SELECT @ScriptGUID = '92ECE0B1-D719-4252-919E-F5A1A11D370D'
	,@Comments = 'DEF-8041 Create Providers'
...
BEGIN TRY
	...
	VALUES 
		 ('GPP','GB',0,0,0),
		 ('Equfund (IPS) Limited','GB',0,0,0),
		 ('AFH Independent Financial Services Limited','GB',0,0,0),
		 ('Radiant Platform Management','GB',0,0,0)
