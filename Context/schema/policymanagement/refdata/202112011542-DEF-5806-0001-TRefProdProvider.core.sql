...
SELECT @ScriptGUID = '5668E2B4-5399-4F8B-BF33-EE2E8360B6E5'
	,@Comments = 'DEF-5806 Create Providers'
...
-----------------------------------------------------------------------------------------------
-- Summary: Add new providers
-- Expected records added: 17 rows
-----------------------------------------------------------------------------------------------
SET NOCOUNT ON
SET XACT_ABORT ON
...
BEGIN TRY
	...
	VALUES 
		 ('Beyond life','GB',0,0,0)
		,('ITC International Pensions Ltd','GB',0,0,0)
		,('Miller Insurance Services LLP','GB',0,0,0)
		,('Mint Property Finance Limited','GB',0,0,0)
		,('Fiske PLC','GB',0,0,0)
		,('Rhino Protect','GB',0,0,0)
		,('FACET Investment Management Ltd','GB',0,0,0)
		,('Kuflink Ltd','GB',0,0,0)
		,('Sovereign Trust (Guernsey) Limited','GB',0,0,0)
		,('Downing','GB',0,0,0)
		,('Unisure','GB',0,0,0)
		,('Netwealth Investments Limited','GB',0,0,0)
		,('Livingbridge Enterprise LLP','GB',0,0,0)
		,('Chip Financial Ltd','GB',0,0,0)
		,('Benenden Health','GB',0,0,0)
		,('Seedrs Ltd','GB',0,0,0)
		,('RC Brown Investment Management Plc','GB',0,0,0)
