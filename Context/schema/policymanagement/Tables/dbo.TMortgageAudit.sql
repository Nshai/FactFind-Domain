...
[IncomeEvidencedFg] [bit] NULL CONSTRAINT [DF_TMortgageAudit_IncomeEvidencedFg] DEFAULT ((0)),
...
[SelfCertFg] [bit] NULL,
[ConcurrencyId] [int] NOT NULL CONSTRAINT [DF_TMortgageAudit_ConcurrencyId] DEFAULT ((1)),
...
[IsAddToMortgageAdvance] [bit] NOT NULL CONSTRAINT [DF__TMortgage__IsAdd__77CD1A8E] DEFAULT ((0)),
...
[AddressId] [int] NULL,
[IsToBeConsolidated] [bit] NOT NULL CONSTRAINT [DF_TMortgageAudit_IsToBeConsolidated] DEFAULT((0)),
[IsLiabilityToBeRepaid] [bit] NULL,
[LiabilityRepaymentDescription] [varchar](500) NULL
)
GO
ALTER TABLE [dbo].[TMortgageAudit] ADD CONSTRAINT [PK_TMortgageAudit] PRIMARY KEY CLUSTERED  ([AuditId])
GO