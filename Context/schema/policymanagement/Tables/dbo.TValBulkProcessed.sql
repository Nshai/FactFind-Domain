CREATE TABLE [dbo].[TValBulkProcessed](
	[ValBulkProcessedId] [bigint] NOT NULL IDENTITY(1, 1) NOT FOR REPLICATION,
...
GO
ALTER TABLE [dbo].[TValBulkProcessed] ADD CONSTRAINT [PK_TValBulkProcessed] PRIMARY KEY NONCLUSTERED([ValBulkProcessedId], [Qtimestamp])
GO
CREATE CLUSTERED INDEX [CLX_TValBulkProcessed_ValScheduleId] ON [dbo].[TValBulkProcessed] (ValScheduleId)
GO
