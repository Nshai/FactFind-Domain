...
[StampDateTime] [datetime] NULL CONSTRAINT [DF_TEquityReleaseAudit_StampDateTime] DEFAULT (getdate()),
...
[AddressId] [int] NULL,
[IsToBeConsolidated] [bit] NOT NULL CONSTRAINT [DF_TEquityReleaseAudit_IsToBeConsolidated] DEFAULT((0)),
[IsLiabilityToBeRepaid] [bit] NULL,
[LiabilityRepaymentDescription] [varchar](500) NULL
)
GO
ALTER TABLE [dbo].[TEquityReleaseAudit] ADD CONSTRAINT [PK_TEquityReleaseAudit] PRIMARY KEY NONCLUSTERED  ([AuditId])
GO
