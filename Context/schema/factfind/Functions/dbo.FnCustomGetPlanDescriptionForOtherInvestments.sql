...
Name          : dbo.FnCustomGetPlanDescriptionForOtherInvestments
Used From     : 1.SpNCustomRetrievePersonalOtherInvestmentsPlans

#################################################################################*/
CREATE FUNCTION dbo.FnCustomGetPlanDescriptionForOtherInvestments   
(    
@CRMContactId  bigint,    
