...
SET ANSI_NULLS ON
GO
CREATE FUNCTION dbo.FnCustomGetTransactionAmountAndType  
(  
...
BEGIN    
 ...
 RCRT.RefContributorTypeName, Null, Null  
 ...
 Where AP.FinancialPlanningId = @FinancialPlanningId and AP.ScenarioId = @ScenarioId   
   
  --Withdrawals  
 INSERT INTO @TempTransactionDetailsTable    
 SELECT AP.ActionPlanId, Null, APW.ActionPlanWithdrawalId, Null, Null,  
 Null, APW.WithdrawalAmount, APW.WithdrawalType  
 ...
 Where AP.FinancialPlanningId = @FinancialPlanningId and AP.ScenarioId = @ScenarioId   
  ...
  ContributionType, Null FROM @TempTransactionDetailsTable   
  ...
  ttd.ContributionType, Null FROM @TempTransactionDetailsTable ttd 
  ...
  Null, ttd.WithdrawalType FROM @TempTransactionDetailsTable ttd  
  Left join @TransactionDetails td on td.ActionPlanId = ttd.ActionPlanId 
